...
/**
 * Volume off icon (Communication).
 *
 * @remarks
 * Differs from {@link volumeIcon} by the addition of the diagonal slash,
 * matching the `eyeOffIcon` convention.
 */
export const volumeOffIcon: IconData = {
  name: "volume-off",
  viewBox: "0 0 24 24",
  width: "1em",
  height: "1em",
